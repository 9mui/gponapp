...
class SnmpClient:
    ...
    def get(self, host: str, community: str, oid: str) -> list[str]:
        lines, _ = self.get_with_status(host=host, community=community, oid=oid)
        return lines

    def get_with_status(self, host: str, community: str, oid: str) -> tuple[list[str], bool]:
        cmd = [
            "snmpget",
            "-v2c",
            "-On",
